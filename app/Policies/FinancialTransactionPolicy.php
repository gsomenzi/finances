...
class FinancialTransactionPolicy
{
    ...
    {
        return $user->id === $financialTransaction->financialAccount->user_id;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, FinancialTransaction $financialTransaction)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, FinancialTransaction $financialTransaction)
    {
        //
    }
}
