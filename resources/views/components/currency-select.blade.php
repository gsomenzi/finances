...
<div class="uk-form-controls">
  <label for="currency" class="uk-form-label">Moeda</label>
  <select class="uk-select" value="{{old("currency")}}" id="currency" name="currency">
      @foreach($currencies as $currency)
      <option @if($selected === $currency["code"]) selected @endif value="{{$currency["code"]}}">{{$currency["name"]}}</option>
      @endforeach
  </select>
</div>